...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import isoband_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9a68df92-36a6-505f-a73e-abb412b6bfb4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "isoband", artifacts_toml) for e in artifacts["isoband"]]
...
if best_platform === nothing
    @debug("Unable to load isoband; unsupported platform $(triplet(platform_key_abi()))")
else
